@extends("layout.layout", ['title' => 'Home Page'])
 ...
 <header class="py-5">
            ...
            <section class="bg-light py-5">
                <div class="container px-5">
                    <div class="row">
                    <h6>First Project</h6>
                    @include("components.project-card", ['item' => $project])
                    <h6>First Experience</h6>
                    @include("components.experience-card", ['item' => $experience])
                    </div>
